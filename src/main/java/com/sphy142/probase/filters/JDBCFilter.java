...
import com.sphy142.probase.conn.ConnectionUtils;
...
public class JDBCFilter implements Filter {
    ...
    private boolean needJDBC(HttpServletRequest request) {
        ...
        // Collection of alla servlets in the Web application
    ...
    public void doFilter(ServletRequest request,
        ...
        } //With commons requests (images,css,html,..) No need to open the connect
        else {
            //Allow request to goforward(Go to the next filter or target)
            chain.doFilter(request, response);
        }
